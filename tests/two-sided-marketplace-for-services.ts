...
describe("two-sided-marketplace-for-services", () => {
  ...
  let priceMint = new anchor.web3.PublicKey("4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU");
  ...
  it("Create a services nft", async () => {
  ...
  it("Update a services nft", async () => {
  ...
  it("Delete a services nft", async () => {
  ...
  it("Create a new services nft", async () => {
